"""
Django settings for ToDoForItPower project.
...
ROOT_URLCONF = 'ToDoForItPower.urls'
...
WSGI_APPLICATION = 'ToDoForItPower.wsgi.application'
...
DJOSER = {
    ...
    'SEND_ACTIVATION_EMAIL': False,  # Реализовать подтверждение перед деплоем
}
